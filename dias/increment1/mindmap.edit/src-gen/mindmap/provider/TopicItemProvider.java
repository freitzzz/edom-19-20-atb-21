...
public class TopicItemProvider extends MapElementItemProvider {
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Topic_subtopics_feature",
								"_UI_Topic_type"),
						MindmapPackage.Literals.TOPIC__SUBTOPICS, true, false, true, null, null, null));
	}
	...
	protected void addParentPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						MindmapPackage.Literals.TOPIC__PARENT, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Topic_description_feature",
								"_UI_Topic_type"),
						MindmapPackage.Literals.TOPIC__DESCRIPTION, true, false, false,
	...
	protected void addStartPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Topic_start_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Topic_start_feature", "_UI_Topic_type"),
						MindmapPackage.Literals.TOPIC__START, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addEndPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Topic_end_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Topic_end_feature", "_UI_Topic_type"),
						MindmapPackage.Literals.TOPIC__END, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addPriorityPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						MindmapPackage.Literals.TOPIC__PRIORITY, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
