...
public class MmapPackageImpl extends EPackageImpl implements MmapPackage {
	...
	public static MmapPackage init() {
		...
		MmapPackageImpl theMmapPackage = (MmapPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof MmapPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
						: new MmapPackageImpl());
