package pt.isep.edom.requirementsdsl.converter;
 ...
 */
public class RequirementsDslValueConverter extends DefaultTerminalConverters {
		...
		return new IValueConverter<java.util.Date>() {
			...
			public java.util.Date toValue(String string, INode node)
				...
				try {
					...
					return new java.util.Date(new SimpleDateFormat("dd-MM-yyyy HH:mm").parse(str2).getTime());
