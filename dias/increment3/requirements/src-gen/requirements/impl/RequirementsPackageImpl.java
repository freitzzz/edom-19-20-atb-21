...
public class RequirementsPackageImpl extends EPackageImpl implements RequirementsPackage {
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation(this, source,
				new String[] { "invocationDelegates", "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
						...
						"http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot" });
		addAnnotation(modelEClass, source, new String[] { "constraints", "mustHaveTitle" });
		addAnnotation(requirementGroupEClass, source,
				new String[] { "constraints", "mustHaveName mustHaveID IDMustBeUnique" });
		addAnnotation(requirementEClass, source,
				new String[] { "constraints", "mustHaveID IDMustBeUnique mustHaveTitle mustHaveCreatedDate" });
		addAnnotation(commentEClass, source,
				new String[] { "constraints", "mustHaveSubject mustHaveBody mustHaveAuthor mustHaveCreatedDate" });
	}
	...
	protected void createPivotAnnotations() {
		...
		addAnnotation(requirementGroupEClass, source,
				new String[] { "mustHaveName", "not name.oclIsUndefined()", "mustHaveID", "not id.oclIsUndefined()",
		...
		addAnnotation(commentEClass, source,
				new String[] { "mustHaveSubject", "not subject.oclIsUndefined()", "mustHaveBody",
						"not body.oclIsUndefined()", "mustHaveAuthor", "not author.oclIsUndefined()",
						"mustHaveCreatedDate", "not created.oclIsUndefined()" });
	}
