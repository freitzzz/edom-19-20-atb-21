 ...
 * </p>
 * <ul>
 *   <li>{@link requirements.impl.VersionImpl#getMajor <em>Major</em>}</li>
 *   <li>{@link requirements.impl.VersionImpl#getMinor <em>Minor</em>}</li>
 *   <li>{@link requirements.impl.VersionImpl#getService <em>Service</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VersionImpl extends MinimalEObjectImpl.Container implements Version {
	...
	public void setService(int newService) {
		...
		service = newService;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RequirementsPackage.VERSION__SERVICE, oldService,
					service));
	}
