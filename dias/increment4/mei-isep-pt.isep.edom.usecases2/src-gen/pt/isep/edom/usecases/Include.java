 ...
 * </p>
 * <ul>
 *   <li>{@link pt.isep.edom.usecases.Include#getUsecase <em>Usecase</em>}</li>
 * </ul>
 *
 * @see pt.isep.edom.usecases.UsecasesPackage#getInclude()
 * @model
 * @generated
 */
public interface Include extends Relationship {
	 ...
	 * @see pt.isep.edom.usecases.UsecasesPackage#getInclude_Usecase()
	 * @model required="true"
	 * @generated
	 */
	UseCase getUsecase();
	...
	/**
	 * Sets the value of the '{@link pt.isep.edom.usecases.Include#getUsecase <em>Usecase</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
