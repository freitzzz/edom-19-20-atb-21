 ...
 *   <li>{@link pt.isep.edom.usecases.UseCaseModel#getName <em>Name</em>}</li>
 * </ul>
 *
...
public interface UseCaseModel extends EObject {
	 ...
	 * @see #setName(String)
	 * @see pt.isep.edom.usecases.UsecasesPackage#getUseCaseModel_Name()
	 * @model
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link pt.isep.edom.usecases.UseCaseModel#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
