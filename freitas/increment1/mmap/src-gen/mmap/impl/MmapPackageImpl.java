...
public class MmapPackageImpl extends EPackageImpl implements MmapPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getTopic_StartDate(), ecorePackage.getEDate(), "startDate", null, 0, 1, Topic.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTopic_EndDate(), ecorePackage.getEDate(), "endDate", null, 0, 1, Topic.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
