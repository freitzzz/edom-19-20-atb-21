...
public class InternalRDSLLexer extends Lexer {
    ...
    public final void mRULE_CUSTOM_DATE_SINGLE_QUOTE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRDSL.g:4596:31: ( ( '\\'' )? ( '0' .. '9' )+ '-' ( '0' .. '9' )+ '-' ( '0' .. '9' )+ ( 'T' ( '0' .. '9' )+ ':' ( '0' .. '9' )+ ':' ( '0' .. '9' )+ ( '.' ( '0' .. '9' )+ '+' ( '0' .. '9' )+ )? )? ( '\\'' )? )
            // InternalRDSL.g:4596:33: ( '\\'' )? ( '0' .. '9' )+ '-' ( '0' .. '9' )+ '-' ( '0' .. '9' )+ ( 'T' ( '0' .. '9' )+ ':' ( '0' .. '9' )+ ':' ( '0' .. '9' )+ ( '.' ( '0' .. '9' )+ '+' ( '0' .. '9' )+ )? )? ( '\\'' )?
            {
            // InternalRDSL.g:4596:33: ( '\\'' )?
            int alt1=2;
            ...
            // InternalRDSL.g:4596:83: ( 'T' ( '0' .. '9' )+ ':' ( '0' .. '9' )+ ':' ( '0' .. '9' )+ ( '.' ( '0' .. '9' )+ '+' ( '0' .. '9' )+ )? )?
            int alt11=2;
            ...
            switch (alt11) {
                case 1 :
                    // InternalRDSL.g:4596:84: 'T' ( '0' .. '9' )+ ':' ( '0' .. '9' )+ ':' ( '0' .. '9' )+ ( '.' ( '0' .. '9' )+ '+' ( '0' .. '9' )+ )?
                    {
                    match('T'); 
                    // InternalRDSL.g:4596:88: ( '0' .. '9' )+
                    int cnt5=0;
                    loop5:
                    do {
                        int alt5=2;
                    ...
                    // InternalRDSL.g:4596:132: ( '.' ( '0' .. '9' )+ '+' ( '0' .. '9' )+ )?
                    int alt10=2;
                    ...
                    switch (alt10) {
                        case 1 :
                            // InternalRDSL.g:4596:133: '.' ( '0' .. '9' )+ '+' ( '0' .. '9' )+
                            {
                            match('.'); 
                            // InternalRDSL.g:4596:137: ( '0' .. '9' )+
                            int cnt8=0;
                            loop8:
                            do {
                                int alt8=2;
    ...
    public final void mRULE_CUSTOM_DATE_DOUBLE_QUOTE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRDSL.g:4598:31: ( ( '\"' )? ( '0' .. '9' )+ '-' ( '0' .. '9' )+ '-' ( '0' .. '9' )+ ( 'T' ( '0' .. '9' )+ ':' ( '0' .. '9' )+ ':' ( '0' .. '9' )+ ( '.' ( '0' .. '9' )+ '+' ( '0' .. '9' )+ )? )? ( '\"' )? )
            // InternalRDSL.g:4598:33: ( '\"' )? ( '0' .. '9' )+ '-' ( '0' .. '9' )+ '-' ( '0' .. '9' )+ ( 'T' ( '0' .. '9' )+ ':' ( '0' .. '9' )+ ':' ( '0' .. '9' )+ ( '.' ( '0' .. '9' )+ '+' ( '0' .. '9' )+ )? )? ( '\"' )?
            {
            // InternalRDSL.g:4598:33: ( '\"' )?
            int alt13=2;
            ...
            // InternalRDSL.g:4598:82: ( 'T' ( '0' .. '9' )+ ':' ( '0' .. '9' )+ ':' ( '0' .. '9' )+ ( '.' ( '0' .. '9' )+ '+' ( '0' .. '9' )+ )? )?
            int alt23=2;
            ...
            switch (alt23) {
                case 1 :
                    // InternalRDSL.g:4598:83: 'T' ( '0' .. '9' )+ ':' ( '0' .. '9' )+ ':' ( '0' .. '9' )+ ( '.' ( '0' .. '9' )+ '+' ( '0' .. '9' )+ )?
                    {
                    match('T'); 
                    // InternalRDSL.g:4598:87: ( '0' .. '9' )+
                    int cnt17=0;
                    loop17:
                    do {
                        int alt17=2;
                    ...
                    // InternalRDSL.g:4598:131: ( '.' ( '0' .. '9' )+ '+' ( '0' .. '9' )+ )?
                    int alt22=2;
                    ...
                    switch (alt22) {
                        case 1 :
                            // InternalRDSL.g:4598:132: '.' ( '0' .. '9' )+ '+' ( '0' .. '9' )+
                            {
                            match('.'); 
                            // InternalRDSL.g:4598:136: ( '0' .. '9' )+
                            int cnt20=0;
                            loop20:
                            do {
                                int alt20=2;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRDSL.g:4600:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalRDSL.g:4600:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalRDSL.g:4600:11: ( '^' )?
            int alt25=2;
            ...
            // InternalRDSL.g:4600:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop26:
            do {
                int alt26=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRDSL.g:4602:10: ( ( '0' .. '9' )+ )
            // InternalRDSL.g:4602:12: ( '0' .. '9' )+
            {
            // InternalRDSL.g:4602:12: ( '0' .. '9' )+
            int cnt27=0;
            loop27:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRDSL.g:4604:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalRDSL.g:4604:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalRDSL.g:4604:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt30=2;
            ...
            switch (alt30) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // InternalRDSL.g:4604:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalRDSL.g:4604:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop29:
                    do {
                        int alt29=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRDSL.g:4606:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalRDSL.g:4606:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalRDSL.g:4606:24: ( options {greedy=false; } : . )*
            loop31:
            do {
                int alt31=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRDSL.g:4608:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalRDSL.g:4608:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalRDSL.g:4608:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop32:
            do {
                int alt32=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRDSL.g:4610:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalRDSL.g:4610:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalRDSL.g:4610:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt35=0;
            loop35:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRDSL.g:4612:16: ( . )
            // InternalRDSL.g:4612:18: .
            {
            matchAny(); 
