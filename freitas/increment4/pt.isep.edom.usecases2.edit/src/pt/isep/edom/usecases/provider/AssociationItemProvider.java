...
/**
 * This is the item provider adapter for a {@link pt.isep.edom.usecases.Association} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UsecasesPackage.Literals.ASSOCIATION__NAME,
				 true,
				 false,
				 false,
	...
	protected void addActorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Association_actor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Association_actor_feature", "_UI_Association_type"),
				 UsecasesPackage.Literals.ASSOCIATION__ACTOR,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addUsecasePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Association_usecase_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Association_usecase_feature", "_UI_Association_type"),
				 UsecasesPackage.Literals.ASSOCIATION__USECASE,
				 true,
				 false,
				 true,
				 null,
