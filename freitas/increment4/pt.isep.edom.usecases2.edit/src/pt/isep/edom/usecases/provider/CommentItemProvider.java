...
/**
 * This is the item provider adapter for a {@link pt.isep.edom.usecases.Comment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CommentItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_Comment_description_feature", "_UI_Comment_type"),
				 UsecasesPackage.Literals.COMMENT__DESCRIPTION,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Comment.class)) {
			case UsecasesPackage.COMMENT__DESCRIPTION:
