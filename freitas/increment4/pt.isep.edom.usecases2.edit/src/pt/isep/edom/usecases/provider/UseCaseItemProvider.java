...
/**
 * This is the item provider adapter for a {@link pt.isep.edom.usecases.UseCase} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UseCaseItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UsecasesPackage.Literals.USE_CASE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UsecasesPackage.Literals.USE_CASE__EXTEND);
			childrenFeatures.add(UsecasesPackage.Literals.USE_CASE__INCLUDE);
			childrenFeatures.add(UsecasesPackage.Literals.USE_CASE__COMMENTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UsecasesPackage.Literals.USE_CASE__EXTEND,
				 UsecasesFactory.eINSTANCE.createExtend()));

		newChildDescriptors.add
			(createChildParameter
				(UsecasesPackage.Literals.USE_CASE__INCLUDE,
				 UsecasesFactory.eINSTANCE.createInclude()));

		newChildDescriptors.add
			(createChildParameter
				(UsecasesPackage.Literals.USE_CASE__COMMENTS,
				 UsecasesFactory.eINSTANCE.createComment()));
	}
