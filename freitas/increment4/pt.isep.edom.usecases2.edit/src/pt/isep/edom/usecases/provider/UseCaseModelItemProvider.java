...
/**
 * This is the item provider adapter for a {@link pt.isep.edom.usecases.UseCaseModel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UseCaseModelItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UsecasesPackage.Literals.USE_CASE_MODEL__ACTOR);
			childrenFeatures.add(UsecasesPackage.Literals.USE_CASE_MODEL__ASSOCIATION);
			childrenFeatures.add(UsecasesPackage.Literals.USE_CASE_MODEL__USECASE);
		}
	...
	public String getText(Object object) {
		return getString("_UI_UseCaseModel_type");
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UsecasesPackage.Literals.USE_CASE_MODEL__ACTOR,
				 UsecasesFactory.eINSTANCE.createActor()));

		newChildDescriptors.add
			(createChildParameter
				(UsecasesPackage.Literals.USE_CASE_MODEL__ASSOCIATION,
				 UsecasesFactory.eINSTANCE.createAssociation()));

		newChildDescriptors.add
			(createChildParameter
				(UsecasesPackage.Literals.USE_CASE_MODEL__USECASE,
	...
	public ResourceLocator getResourceLocator() {
		return Usecases2EditPlugin.INSTANCE;
	}
