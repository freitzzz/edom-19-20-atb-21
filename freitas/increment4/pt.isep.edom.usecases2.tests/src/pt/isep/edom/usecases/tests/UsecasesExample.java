...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>usecases</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class UsecasesExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.usecases"));
				UseCaseModel root = UsecasesFactory.eINSTANCE.createUseCaseModel();
