...
public class Generate extends AbstractAcceleoGenerator {
	 ...
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "/usecasestojavacli/main/generate";
	 ...
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "generateJavaConsoleApplication" };
	...
	public void registerPackages(ResourceSet resourceSet) {
		...
		// For the use cases
		if (!isInWorkspace(UsecasesPackage.class)) {
	...
	public void registerResourceFactories(ResourceSet resourceSet) {
		...
		// For the Use Cases Textual DSL
		// do this only once per application
		Injector injector = new UseCasesDslStandaloneSetup().createInjectorAndDoEMFRegistration();
	}
