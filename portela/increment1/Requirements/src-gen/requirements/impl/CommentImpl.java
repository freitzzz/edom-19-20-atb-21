...
public class CommentImpl extends MinimalEObjectImpl.Container implements Comment {
	...
	public void setSubject(String newSubject) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RequirementsPackage.COMMENT__SUBJECT, oldSubject,
					subject));
	}
	...
	public void setAuthor(String newAuthor) {
		...
		author = newAuthor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RequirementsPackage.COMMENT__AUTHOR, oldAuthor,
					author));
	}
	...
	public void setCreated(Date newCreated) {
		...
		created = newCreated;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RequirementsPackage.COMMENT__CREATED, oldCreated,
					created));
	}
