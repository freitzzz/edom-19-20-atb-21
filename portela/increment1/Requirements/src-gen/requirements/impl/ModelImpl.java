 ...
 *   <li>{@link requirements.impl.ModelImpl#getRequirementgroup <em>Requirementgroup</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModelImpl extends MinimalEObjectImpl.Container implements Model {
	...
	/**
	 * The cached value of the '{@link #getRequirementgroup() <em>Requirementgroup</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EList<RequirementGroup> getRequirementgroup() {
		if (requirementgroup == null) {
			requirementgroup = new EObjectContainmentEList<RequirementGroup>(RequirementGroup.class, this,
					RequirementsPackage.MODEL__REQUIREMENTGROUP);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case RequirementsPackage.MODEL__REQUIREMENTGROUP:
