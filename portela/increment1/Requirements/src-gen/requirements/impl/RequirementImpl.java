...
public class RequirementImpl extends MinimalEObjectImpl.Container implements Requirement {
	 ...
	 * @ordered
	 */
	protected static final State STATE_EDEFAULT = State.INVALID;
	 ...
	 * @ordered
	 */
	protected static final Resolution RESOLUTION_EDEFAULT = Resolution.NEW;
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RequirementsPackage.REQUIREMENT__DESCRIPTION,
	...
	public void setAuthor(String newAuthor) {
		...
		author = newAuthor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RequirementsPackage.REQUIREMENT__AUTHOR, oldAuthor,
					author));
	}
	...
	public void setCreated(Date newCreated) {
		...
		created = newCreated;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RequirementsPackage.REQUIREMENT__CREATED, oldCreated,
					created));
	}
	...
	public void setType(Type newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RequirementsPackage.REQUIREMENT__TYPE, oldType,
					type));
	}
	...
	public void setPriority(Priority newPriority) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RequirementsPackage.REQUIREMENT__PRIORITY,
	...
	public void setState(State newState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RequirementsPackage.REQUIREMENT__STATE, oldState,
					state));
	}
	...
	public void setResolution(Resolution newResolution) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RequirementsPackage.REQUIREMENT__RESOLUTION,
	...
	public NotificationChain basicSetVersion(Version newVersion, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					RequirementsPackage.REQUIREMENT__VERSION, oldVersion, newVersion);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newVersion != version) {
			...
			if (version != null)
				msgs = ((InternalEObject) version).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - RequirementsPackage.REQUIREMENT__VERSION, null, msgs);
			if (newVersion != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RequirementsPackage.REQUIREMENT__VERSION, newVersion,
					newVersion));
	}
	...
	public EList<Requirement> getChildren() {
		if (children == null) {
			children = new EObjectContainmentWithInverseEList<Requirement>(Requirement.class, this,
					RequirementsPackage.REQUIREMENT__CHILDREN, RequirementsPackage.REQUIREMENT__PARENT);
		}
		return children;
	}
	...
	public Requirement getParent() {
		if (eContainerFeatureID() != RequirementsPackage.REQUIREMENT__PARENT)
			return null;
	...
	public void setParent(Requirement newParent) {
		if (newParent != eInternalContainer()
				|| (eContainerFeatureID() != RequirementsPackage.REQUIREMENT__PARENT && newParent != null)) {
			...
			if (newParent != null)
				msgs = ((InternalEObject) newParent).eInverseAdd(this, RequirementsPackage.REQUIREMENT__CHILDREN,
						Requirement.class, msgs);
			msgs = basicSetParent(newParent, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RequirementsPackage.REQUIREMENT__PARENT, newParent,
					newParent));
	}
	...
	public EList<Requirement> getDependencies() {
		if (dependencies == null) {
			dependencies = new EObjectResolvingEList<Requirement>(Requirement.class, this,
					RequirementsPackage.REQUIREMENT__DEPENDENCIES);
		}
		return dependencies;
	}
	...
	public EList<Comment> getComments() {
		if (comments == null) {
			comments = new EObjectContainmentEList<Comment>(Comment.class, this,
					RequirementsPackage.REQUIREMENT__COMMENTS);
		}
		return comments;
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case RequirementsPackage.REQUIREMENT__PARENT:
			return eInternalContainer().eInverseRemove(this, RequirementsPackage.REQUIREMENT__CHILDREN,
					Requirement.class, msgs);
		}
