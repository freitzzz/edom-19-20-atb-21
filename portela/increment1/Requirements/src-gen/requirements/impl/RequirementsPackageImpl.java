...
public class RequirementsPackageImpl extends EPackageImpl implements RequirementsPackage {
	 ...
	 * @generated
	 */
	public EReference getModel_Requirementgroup() {
	...
	public void createPackageContents() {
		...
		createEReference(modelEClass, MODEL__REQUIREMENTGROUP);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getRequirement_Priority(), this.getPriority(), "priority", "HIGH", 0, 1, Requirement.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRequirement_State(), this.getState(), "state", "INVALID", 0, 1, Requirement.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRequirement_Resolution(), this.getResolution(), "resolution", "NEW", 0, 1, Requirement.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getModel_Title(), ecorePackage.getEString(), "title", null, 0, 1, Model.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getModel_Requirementgroup(), this.getRequirementGroup(), null, "requirementgroup", null, 0, -1,
		...
		addEEnumLiteral(stateEEnum, State.INVALID);
		addEEnumLiteral(stateEEnum, State.ACCEPTED);
		addEEnumLiteral(stateEEnum, State.IMPLEMENTED);
		addEEnumLiteral(stateEEnum, State.LATER);
		...
		addEEnumLiteral(resolutionEEnum, Resolution.NEW);
		addEEnumLiteral(resolutionEEnum, Resolution.REVIEWED);
		addEEnumLiteral(resolutionEEnum, Resolution.APPROVED);
		addEEnumLiteral(resolutionEEnum, Resolution.RESOLVED);
