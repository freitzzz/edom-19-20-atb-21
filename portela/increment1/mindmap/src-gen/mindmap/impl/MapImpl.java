...
public class MapImpl extends MinimalEObjectImpl.Container implements Map {
	 ...
	 * @ordered
	 */
	protected EStructuralFeature.Internal.SettingDelegate ROOT_TOPICS__ESETTING_DELEGATE = ((EStructuralFeature.Internal) MindmapPackage.Literals.MAP__ROOT_TOPICS)
			.getSettingDelegate();
