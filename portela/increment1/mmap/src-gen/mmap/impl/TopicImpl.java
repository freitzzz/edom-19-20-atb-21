 ...
 *   <li>{@link mmap.impl.TopicImpl#getStart <em>Start</em>}</li>
 *   <li>{@link mmap.impl.TopicImpl#getEnd <em>End</em>}</li>
 *   <li>{@link mmap.impl.TopicImpl#getType <em>Type</em>}</li>
...
public class TopicImpl extends MapElementImpl implements Topic {
	...
	public void setType(Type newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MmapPackage.TOPIC__TYPE, oldType, type));
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case MmapPackage.TOPIC___ALL_SUB_TOPICS:
			return allSubTopics();
		}
