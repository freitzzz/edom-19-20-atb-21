 ...
 * </p>
 * <ul>
 *   <li>{@link pt.isep.edom.project.c0.mm.usecase.Extend#getUsecase <em>Usecase</em>}</li>
 * </ul>
 *
 * @see pt.isep.edom.project.c0.mm.usecase.UsecasePackage#getExtend()
 * @model
 * @generated
 */
public interface Extend extends Relationship {
	 ...
	 * @see pt.isep.edom.project.c0.mm.usecase.UsecasePackage#getExtend_Usecase()
	 * @model required="true"
	 * @generated
	 */
	UseCase getUsecase();
	...
	/**
	 * Sets the value of the '{@link pt.isep.edom.project.c0.mm.usecase.Extend#getUsecase <em>Usecase</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
