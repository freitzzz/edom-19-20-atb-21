 ...
 * </p>
 * <ul>
 *   <li>{@link pt.isep.edom.project.c0.mm.usecase.impl.AssociationImpl#getName <em>Name</em>}</li>
 *   <li>{@link pt.isep.edom.project.c0.mm.usecase.impl.AssociationImpl#getActor <em>Actor</em>}</li>
 *   <li>{@link pt.isep.edom.project.c0.mm.usecase.impl.AssociationImpl#getUsecase <em>Usecase</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AssociationImpl extends MinimalEObjectImpl.Container implements Association {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UsecasePackage.ASSOCIATION__NAME, oldName, name));
	}
	...
	public Actor getActor() {
		if (actor != null && actor.eIsProxy()) {
			...
			if (actor != oldActor) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UsecasePackage.ASSOCIATION__ACTOR,
							oldActor, actor));
			}
		}
		return actor;
	...
	public UseCase getUsecase() {
		if (usecase != null && usecase.eIsProxy()) {
			...
			if (usecase != oldUsecase) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UsecasePackage.ASSOCIATION__USECASE,
							oldUsecase, usecase));
			}
		}
		return usecase;
	...
	public void setUsecase(UseCase newUsecase) {
		...
		usecase = newUsecase;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UsecasePackage.ASSOCIATION__USECASE, oldUsecase,
					usecase));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case UsecasePackage.ASSOCIATION__NAME:
			return getName();
