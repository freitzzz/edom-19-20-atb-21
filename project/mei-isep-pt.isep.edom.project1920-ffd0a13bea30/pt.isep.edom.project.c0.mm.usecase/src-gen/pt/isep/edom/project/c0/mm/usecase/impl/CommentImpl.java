 ...
 * </p>
 * <ul>
 *   <li>{@link pt.isep.edom.project.c0.mm.usecase.impl.CommentImpl#getDescription <em>Description</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CommentImpl extends MinimalEObjectImpl.Container implements Comment {
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UsecasePackage.COMMENT__DESCRIPTION, oldDescription,
					description));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case UsecasePackage.COMMENT__DESCRIPTION:
