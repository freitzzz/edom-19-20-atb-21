package pt.isep.edom.project.c1.atl.nav;
...
public class UseCase2Nav {
	...
	public static void registerEcorePackages() {
		...
		Injector injector2 = new NavStandaloneSetup().createInjectorAndDoEMFRegistration();
	...
	public static void main(String[] args) {
		// Resolve arguments
		String argTransformation="transformations::usecase2nav";
		String argModelIn="dsl/gorgeousfood.usecase";
		String argModelOut="dsl/gorgeousfood.nav";
		...
		metaModel2.setResource(rs.getResource(URI.createURI("http://www.example.org/nav"), true));
		env.registerMetaModel("MMNav", metaModel2);
		...
		mr = new ClassModuleResolver(UseCase2Nav.class);
