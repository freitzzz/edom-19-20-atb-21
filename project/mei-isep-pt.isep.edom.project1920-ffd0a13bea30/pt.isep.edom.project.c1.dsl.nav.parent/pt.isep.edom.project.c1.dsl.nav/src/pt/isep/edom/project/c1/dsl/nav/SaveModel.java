...
public class SaveModel {
	...
	public static void saveModel() {
		...
		Injector injector = new NavStandaloneSetup().createInjectorAndDoEMFRegistration();
        ...
        NavFactory factory = NavFactory.eINSTANCE;
        
        // Create a map
        NavModel myNav = factory.createNavModel();
        myNav.setName("GorgeousFood");
                
        // create a resource
        Resource resource = resSet.createResource(URI.createURI("instances/gorgeousfood.nav"));

        resource.getContents().add(myNav);
...
//        }
        ...
        Diagnostic diag=Diagnostician.INSTANCE.validate(myNav);
