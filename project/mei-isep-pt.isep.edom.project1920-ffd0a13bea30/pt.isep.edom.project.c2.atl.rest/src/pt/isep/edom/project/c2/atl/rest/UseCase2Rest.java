package pt.isep.edom.project.c2.atl.rest;
...
public class UseCase2Rest {
	...
	public static void registerEcorePackages() {
		...
		Injector injector2 = new RestStandaloneSetup().createInjectorAndDoEMFRegistration();
	...
	public static void main(String[] args) {
		// Resolve arguments
		String argTransformation="transformations::usecase2rest";
		String argModelIn="dsl/gorgeousfood.usecase";
		String argModelOut="dsl/gorgeousfood.rest";
		...
		metaModel2.setResource(rs.getResource(URI.createURI("http://www.example.org/rest"), true));
		env.registerMetaModel("MMRest", metaModel2);
		...
		mr = new ClassModuleResolver(UseCase2Rest.class);
