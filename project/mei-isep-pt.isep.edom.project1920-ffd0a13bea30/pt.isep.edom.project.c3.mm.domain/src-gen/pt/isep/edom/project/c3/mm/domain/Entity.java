 ...
 * @model annotation="http://www.eclipse.org/emf/2002/Ecore constraints='NameCannotBeNull NameCanOnlyContainAlphaNumericCharactersAndSpaces NameLengthMustBeEqualOrGreaterThanThree MustHaveAtLeastIdAndNameFields CannotHaveDuplicatedFields CannotHaveSubEntityThatReferenceTheEntityThatContainsTheSubEntity'"
 *        annotation="http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot NameCannotBeNull='not self.name.oclIsUndefined()' NameCanOnlyContainAlphaNumericCharactersAndSpaces='self.name.matches(\'^[A-Za-z ]+$\')' NameLengthMustBeEqualOrGreaterThanThree='self.name.size() &gt;= 3' MustHaveAtLeastIdAndNameFields='\n\t\t\tself.fields -&gt; select(field : Field | field.name = \'id\' or field.name = \'name\') -&gt; size() = 2\n\t\t' CannotHaveDuplicatedFields='\n\t\t\tself.fields -&gt; collect(field : Field | field.name) -&gt; asSet() -&gt; size() = self.fields -&gt; size()\n\t\t' CannotHaveSubEntityThatReferenceTheEntityThatContainsTheSubEntity='\n\t\t\tself.subentities -&gt; select(subEntity : SubEntity | subEntity.entity = self) -&gt; isEmpty()\n\t\t'"
 * @generated
 */
