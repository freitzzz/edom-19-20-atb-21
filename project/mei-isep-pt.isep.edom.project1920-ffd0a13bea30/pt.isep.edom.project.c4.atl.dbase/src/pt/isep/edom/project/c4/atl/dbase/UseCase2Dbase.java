package pt.isep.edom.project.c4.atl.dbase;
...
public class UseCase2Dbase {
	...
	public static void main(String[] args) {
		// Resolve arguments
		String argTransformation="transformations::usecase2dbase";
		String argModelIn="dsl/gorgeousfood.usecase";
		String argModelOut="dsl/gorgeousfood.dbase";
		...
		metaModel2.setResource(rs.getResource(URI.createURI("http://www.example.org/dbase"), true));
		env.registerMetaModel("MMDbase", metaModel2);
		...
		mr = new ClassModuleResolver(UseCase2Dbase.class);
