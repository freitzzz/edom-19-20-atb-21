 ...
 * @generated
 */
public class DbaseFactoryImpl extends EFactoryImpl implements DbaseFactory {
	/**
	 ...
	 * @generated
	 */
	public static DbaseFactory init() {
		try {
			DbaseFactory theDbaseFactory = (DbaseFactory) EPackage.Registry.INSTANCE.getEFactory(DbasePackage.eNS_URI);
			if (theDbaseFactory != null) {
				return theDbaseFactory;
			}
		} catch (Exception exception) {
			EcorePlugin.INSTANCE.log(exception);
		}
		return new DbaseFactoryImpl();
	}
	 ...
	 * @generated
	 */
	public DbaseModel createDbaseModel() {
		DbaseModelImpl dbaseModel = new DbaseModelImpl();
		return dbaseModel;
	}
	 ...
	 * @generated
	 */
	public DbasePackage getDbasePackage() {
		return (DbasePackage) getEPackage();
	}
	 ...
	 */
	@Deprecated
	public static DbasePackage getPackage() {
