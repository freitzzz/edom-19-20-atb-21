...
public class TableImpl extends MinimalEObjectImpl.Container implements Table {
	...
	protected EClass eStaticClass() {
		return DbasePackage.Literals.TABLE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbasePackage.TABLE__NAME, oldName, name));
	}
	...
	public EList<Column> getColumns() {
		if (columns == null) {
			columns = new EObjectContainmentEList<Column>(Column.class, this, DbasePackage.TABLE__COLUMNS);
		}
		return columns;
	}
	...
	public void setEntity(String newEntity) {
		...
		entity = newEntity;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbasePackage.TABLE__ENTITY, oldEntity, entity));
	}
