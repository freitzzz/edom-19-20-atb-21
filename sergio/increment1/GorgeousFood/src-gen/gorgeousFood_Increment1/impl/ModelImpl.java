 ...
 * </p>
 * <ul>
 *   <li>{@link gorgeousFood_Increment1.impl.ModelImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link gorgeousFood_Increment1.impl.ModelImpl#getGroups <em>Groups</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModelImpl extends MinimalEObjectImpl.Container implements Model {
	...
	protected EClass eStaticClass() {
		return GorgeousFood_Increment1Package.Literals.MODEL;
	}
	...
	public void setTitle(String newTitle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GorgeousFood_Increment1Package.MODEL__TITLE, oldTitle,
					title));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case GorgeousFood_Increment1Package.MODEL__TITLE:
			return getTitle();
		case GorgeousFood_Increment1Package.MODEL__GROUPS:
			return getGroups();
		}
